...
[![My Skills](https://skillicons.dev/icons?i=lua,html,css,js,ts,git,nodejs,python,github,gradle,bash,termux,mysql,kali,php,vscode,atom,blender,bootstrap,c,cs,cpp,disocrd,bots,discordjs,godot,unity)](https://skillicons.dev)
<br />
